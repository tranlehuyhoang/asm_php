                                    ...
                                    <form class="form form--review" method="post">
                                        ...
                                        <div class="form__group clearfix mb--20" style="display: none;">
                                            <label class="form__label d-block" for="review_name">Name
                                                <sup>*</sup></label>
                                            <input id="review_name" name="reviewuserid" value="<?php echo $_SESSION['userid'] ?>" class="form__input">
                                        </div>
                                        <div class="form__group clearfix mb--20" style="display: none;">
                                            <label class="form__label d-block" for="review_email">Email
                                                <sup>*</sup></label>
                                            <input id="review_email" name="reviewproductid" value="<?php echo $catId ?>" class="form__input">
                                        </div>
                                        <div class="form__group clearfix mb--20">
                                            <label class="form__label d-block" for="review">Your Review
                                                <sup>*</sup></label>
                                            <textarea id="review" name="reviewcontent" class="form__input form__input--textarea"></textarea>
                                        ...
                                        <div class="form__group text-right">
                                            <button type="submit" name="review" value="1" class="btn btn-medium btn-style-1">Continue</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                                            ...
                                            <div class="mirora-product">
                                                <div class="product-img">
                                                    ...
                                                    <div class="product-img-overlay">
                                                        ...
                                                        <a href="ProductDetail.php?productid=<?php echo $result['productid']; ?>" class="btn btn-transparent btn-fullwidth btn-medium btn-style-1">Quick
                                                            View</a>
                                                    </div>
                                                </div>
                                                <div class="product-content text-center">
                                                    <span>Cartier</span>
                                                    <h4><a href="ProductDetail.php?productid=<?php echo $result['productid']; ?>"><?php echo  $result['productname']; ?></a>
                                                    </h4>
