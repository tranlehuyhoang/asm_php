...
<body cz-shortcut-listen="true">
    ...
    <div class="page">
            ...
            <div class="main-header-container container-fluid">
                <div class="header-content-left">
                    ...
                    <div class="header-element">
                        <div class="horizontal-logo"> <a href="http://localhost/asmnew/" class="header-logo"> <img src="../assets/images/brand-logos/desktop-logo.png" alt="logo" class="desktop-logo">
        ...
        <aside class="app-sidebar sticky" id="sidebar">
            ...
            <div class="main-sidebar-header"> <a href="http://localhost/asmnew/" class="header-logo"> <img src="../assets/images/brand-logos/desktop-logo.png" alt="logo" class="desktop-logo">
                    <img src="../assets/images/brand-logos/toggle-logo.png" alt="logo" class="toggle-logo">
                                ...
                                <div class="simplebar-content" style="padding: 8px 0px 80px;">
                                    ...
                                    <nav class="main-menu-container nav nav-pills flex-column sub-open open active">
                                        ...
                                        <ul class="main-menu" style="display: block; margin-left: 0px; margin-right: 0px;">
                                            ...
                                            <!-- End::slide__category -->
                                            <!-- Start::slide -->
                                            <li class="slide has-sub active open"> <a href="<?php echo $host ?>page/Home.php" class="side-menu__item active"> <i class="bx bx-home side-menu__icon"></i> <span class="side-menu__label">Dashboards<span class="badge bg-warning-transparent ms-2">12</span></span>
