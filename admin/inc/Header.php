...
<body cz-shortcut-listen="true">
                ...
                <div class="tab-pane fade show active border-0" id="switcher-home" role="tabpanel"
                    ...
                    <div class="sidemenu-layout-styles">
                        ...
                        <div class="row switcher-style gx-0 pb-2 gy-2">
                            <div class="col-sm-6">
                                <div class="form-check switch-select"><label class="form-check-label"
                                        for="switcher-default-menu">Default Menu </label><input class="form-check-input"
                                        type="radio" name="sidemenu-layout-styles" id="switcher-default-menu"
                                        checked=""></div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-check switch-select"><label class="form-check-label"
                            ...
                            <div class="col-sm-6">
                                <div class="form-check switch-select"><label class="form-check-label"
                                        for="switcher-icon-overlay">Icon Overlay </label><input class="form-check-input"
                                        type="radio" name="sidemenu-layout-styles" id="switcher-icon-overlay"></div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-check switch-select"><label class="form-check-label"
                    ...
                    <div class="">
                        ...
                        <div class="row switcher-style gx-0">
                            ...
                            <div class="col-4">
                                <div class="form-check switch-select"><label class="form-check-label"
                                        for="switcher-boxed">Boxed </label><input class="form-check-input" type="radio"
                                        name="layout-width" id="switcher-boxed"></div>
                            </div>
                        </div>
                    </div>
                    <div class="">
                    ...
                    <div class="">
                        ...
                        <div class="row switcher-style gx-0">
                            ...
                            <div class="col-4">
                                <div class="form-check switch-select"><label class="form-check-label"
                                        for="switcher-header-scroll">Scrollable </label><input class="form-check-input"
                                        type="radio" name="header-positions" id="switcher-header-scroll"></div>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="d-flex flex-wrap align-items-center switcher-style">
                                ...
                                <div class="form-check switch-select ps-0 mt-1 color-primary-light">
                                    ...
                                    <div class="pickr-container-primary">
                                        <div class="pickr"><button type="button" class="pcr-button" role="button"
                                                aria-label="toggle color picker dialog"
                                                style="--pcr-color: rgba(132, 90, 223, 1);"></button></div>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="page">
            ...
            <div class="main-header-container container-fluid">
                <div class="header-content-left">
                    ...
                    <div class="header-element">
                        <div class="horizontal-logo"> <a href="http://localhost/asmnew/" class="header-logo"> <img
                ...
                <div class="header-content-right">
                            ...
                            <div class="p-5 empty-item d-none">
                                <div class="text-center"> <span
                                    ...
                                    <h6 class="fw-bold mb-1 mt-3">Your Cart is Empty</h6> <span
                                        class="mb-3 fw-normal fs-13 d-block">Add some items to make me happy
                                        :)</span>
                    ...
                    <div class="header-element notifications-dropdown" style="display: none;">
                        <!-- Start::header-link|dropdown-toggle --> <a href="javascript:void(0);"
                            ...
                            <span class="badge bg-secondary rounded-pill header-icon-badge pulse pulse-secondary"
                                id="notification-icon-badge">5</span> </a>
                            ...
                            <div class="p-3">
                                <div class="d-flex align-items-center justify-content-between">
                                    <p class="mb-0 fs-17 fw-semibold">Notifications</p><span
                                        class="badge bg-secondary-transparent" id="notifiation-data">5
                                        Unread</span>
                                </div>
                            </div>
                                                    ...
                                                    <li class="dropdown-item">
                                                        <div class="d-flex align-items-start">
                                                            ...
                                                            <div
                                                                ...
                                                                <div>
                                                                    <p class="mb-0 fw-semibold"><a
                                                                            href="notifications.html">Discount
                                                                            Available</a></p><span
                                                    ...
                                                    <li class="dropdown-item">
                                                        <div class="d-flex align-items-start">
                                                            ...
                                                            <div
                                                                ...
                                                                <div>
                                                                    <p class="mb-0 fw-semibold"><a
                                                                            href="notifications.html">Account
                                                                            Has Been
                                                                            Verified</a></p><span
                                                    ...
                                                    <li class="dropdown-item">
                                                        <div class="d-flex align-items-start">
                                                            ...
                                                            <div
                                                                ...
                                                                <div>
                                                                    <p class="mb-0 fw-semibold"><a
                                                                            href="notifications.html">Order
                                                                            Placed <span class="text-warning">ID:
                                                                                #1116773</span></a></p><span
                                                                        class="text-muted fw-normal fs-12 header-notification-text">Order
                                                    ...
                                                    <div class="row g-2">
                                                        <div class="col-4"> <a href="javascript:void(0);">
                                                                <div class="text-center p-3 related-app"> <span
                                                                        ...
                                                                        <img src="../assets/images/apps/figma.png"
                                                                            alt="">
                    ...
                    <div class="header-element header-fullscreen">
                        <!-- Start::header-link --> <a onclick="openFullscreen();" href="#" class="header-link">
                            <i class="bx bx-fullscreen full-screen-open header-link-icon"></i> <i
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-sm-block d-none">
                                    <p class="fw-semibold mb-0 lh-1"><?php
                                                                        if (isset($_SESSION['useradmin'])) {
                                                                            $get = $logout->getuserbyid($_SESSION['useradmin']);
                                                                            if (isset($get)) {
                    ...
                    <div class="header-element">
                        <a onclick="return confirm('Xác nhận đăng xuất')" href="?action=logout" class="header-link">
                            <i class="ti ti-logout fs-18 me-2 op-7"></i> <i
                                class="bx bx-exit-fullscreen full-screen-close header-link-icon d-none"></i>
                        </a>
                    </div> <!-- End::header-element -->
        ...
        <aside class="app-sidebar sticky" id="sidebar">
            ...
            <div class="main-sidebar-header"> <a href="http://localhost/asmnew/" class="header-logo"> <img
                        src="../assets/images/brand-logos/desktop-logo.png" alt="logo" class="desktop-logo">
                    <img src="../assets/images/brand-logos/toggle-logo.png" alt="logo" class="toggle-logo">
            ...
            <div class="main-sidebar" id="sidebar-scroll" data-simplebar="init">
                                ...
                                <div class="simplebar-content" style="padding: 8px 0px 80px;">
                                    ...
                                    <nav class="main-menu-container nav nav-pills flex-column sub-open open active">
                                        ...
                                        <ul class="main-menu"
                                            ...
                                            <!-- End::slide__category -->
                                            <!-- Start::slide -->
                                            <li class="slide has-sub active open"> <a href="Home.php"
                                                ...
                                                <ul class="slide-menu child1 active"
                                                    style="position: relative; left: 0px; top: 0px; margin: 0px; box-sizing: border-box; display: block; transform: translate(12.5px, 490px);"
                                                    data-popper-placement="bottom">
                                                    <li class="slide side-menu__label1"> <a
                                                            href="javascript:void(0)">Dashboards</a> </li>

                                                    <li class="slide"> <a href="../page/Banner.admin.php"
                                                            class="side-menu__item">Banners +</a> </li>
                                                    ...
                                                    <li class="slide"> <a href="../page/Code.admin.php"
                                                            class="side-menu__item">Codes + </a> </li>
                                                    <li class="slide"> <a href="../page/Compare.admin.php"
                                                            class="side-menu__item">Compare + </a> </li>
                                                    ...
                                                    <li class="slide"> <a href="../page/User.admin.php"
                                                            class="side-menu__item">Users + </a> </li>
                                                    <li class="slide"> <a href="../page/Wishlist.admin.php"
                                                            class="side-menu__item">Wishlists + </a> </li>
                                                </ul>
                                            </li> <!-- End::slide -->
                ...
                <div class="simplebar-track simplebar-vertical" style="visibility: visible;">
                    <div class="simplebar-scrollbar"
                        style="height: 323px; transform: translate3d(0px, 209px, 0px); display: block;">
                    </div>
                </div>
