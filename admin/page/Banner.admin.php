             ...
             <div class="col-xl-12">
                 <div class="card custom-card">
                     <div class="card-body d-flex align-items-center justify-content-between">
                         ...
                         <div class="d-flex" role="search"> <input class="form-control form-control-sm me-2"
                                 type="search" placeholder="Search" aria-label="Search"> <button
                                 class="btn btn-sm btn-light" type="submit">Search</button> </div>
                     </div>
                     <?php
                        if (isset($delete)) {
                            echo $delete;
                     ...
                     <div class="card-body p-0">
                         <div id="carouselExampleSlidesOnly" class="carousel slide carousel-fade"
                             ...
                             <div class="carousel-inner">
                                 <div class="carousel-item active" data-bs-interval="2000"> <a
                                         href="javascript:void(0);">
                                         <img src="<?php echo 'data:image/png;base64,' . base64_encode($result['bannerimg']); ?>"
                                             class="d-block w-100" alt="...">
                                         <div class="carousel-caption blog-caption text-start">
                                             <div class="d-flex gap-2">
                                                 <div class="edit">
                                                     <a
                                                         href="../edits/banner.edit.php?editid=<?php echo $result['bannerid']; ?>">
                                                 ...
                                                 <div class="remove">
                                                     <a onclick="return confirm('Xác nhận xóa')"
                                                         href="?delid=<?php echo $result['bannerid']; ?>">
                                             ...
                                             <div class="d-flex align-items-center"> <span
                                                     class="avatar avatar-sm avatar-rounded me-2"> <img
                                                         src="<?php echo 'data:image/png;base64,' . base64_encode($result['productimg']); ?>"
                                                         alt=""> </span>
                                                 <div class="fw-semibold"> <?php echo  $result['productname']; ?>- <span
                                                         class="fs-11 op-7 fw-normal"><?php echo $result['productdate']; ?>
