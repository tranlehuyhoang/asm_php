...
if (isset($_GET['delid'])) {
    $catid = $_GET['delid'];
    $delete = $cat->delete_category($catid);
    $get = $cat->show_category();
}
?>
            ...
            <div class="col-xl-12">
                <div class="card custom-card">
                    <div class="card-header">
                        <div class="card-title"> Category Datatable
                            <a href="../creates/Category.create.php"><button type="button" class="btn btn-info">Create
                                    +</button></a>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <tbody>
                                ...
                                ?>
                                            <tr>
                                                ...
                                                <td><?php echo $result['categorydate'] ?></td>
                                                <td>
                                                    <div class="d-flex gap-2">
                                                        <div class="edit">
                                                            <a href="../edits/Category.edit.php?catid=<?php echo $result['categoryid']; ?>">
                                                                <button class="btn btn-sm btn-success edit-item-btn" data-bs-toggle="modal" data-bs-target="#showModal">Edit</button>
                                                            </a>
                                                        </div>
                                                        <div class="remove">
                                                            <a onclick="return confirm('Xác nhận xóa')" href="?delid=<?php echo $result['categoryid']; ?>">
